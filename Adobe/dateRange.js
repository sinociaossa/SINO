...
$.fn.dataTableExt.afnFiltering.push(
    function( oSettings, aData, iDataIndex ) {
        var iFini = document.getElementById('max').value;
        var iFfin = document.getElementById('min').value;
        ...
        var datofini=aData[iStartDateCol].substring(0,9);
        var datoffin=aData[iEndDateCol].substring(0,9);
