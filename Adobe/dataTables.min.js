...
(function (f) {
    ...
    function tb(a) {
        var b = a.oClasses,
            ...
            g = '<input type="search" class="ds-input search-bar' + b.sFilterInput + '"/>', k = d.sSearch;
        ...
        var m =
            f("input", b).val(e.sSearch).attr("placeholder", "Search Here").on("keyup.DT search.DT input.DT paste.DT cut.DT", h ? Ra(l, h) : l).on("mouseup", function (a) {
                setTimeout(function () {
                    l.call(m[0])
                }, 10)
    ...
    function sb(a) {
        ...
        d = e ? d[1] : d;
        e = f("<select/>", {name: c + "_length", "aria-controls": c, "class": "dropdown"});
